...
<<<<<<< HEAD
  geom_line(aes(color = sample_id, linetype = sample_id), show.legend = FALSE)
  # geom_vline(aes(xintercept = as.numeric(1989))
=======
  ...
  theme(axis.text.x = element_blank(),
        ...
        legend.title = element_text("Sample ID"))+
  labs(y = "K mg l\u207b\u00b9", 
       fill = "Sample ID")
>>>>>>> 8f8237234d5ee07c4fb4216fb990e86fb2664116
